public class CPU {
    ...
    private final Word[] m;   // m é o array de memória "física", CPU tem uma ref a m para acessar
    ...
    private final boolean debug;      // se true entao mostra cada instrucao em execucao
